...
meta_title: "Why Do I Push People Away? A Guide for the Avoidant High-Achiever | West Oak Therapy"
meta_description: "You want closeness. You also need an exit. The pattern repeats with every relationship — and you're starting to suspect it's not about them. A guide for the avoidant high-performer."
primary_keyword: "why do I push people away in relationships"
secondary_keywords:
  - "avoidant attachment in marriage"
  - "fear of intimacy"
  - "why do I keep sabotaging relationships"
  - "dismissive avoidant attachment"
  - "why do I run when things get serious"
target_persona: "The Avoidant Achiever (Marcus)"
content_tier: "Tier 1 - Problem-Language"
word_count_target: 3000
schema_type: "Article"
canonical_url: "https://westoaktherapy.com/why-you-keep-running-from-the-relationships-you-want"
internal_links:
  - "/avoidant-attachment-in-marriage-when-closeness-feels-like-danger"
  - "/why-did-i-cheat-understanding-the-affair-as-an-exit"
  - "/the-fight-you-keep-having-and-what-its-really-about"
  - "/services/individual-therapy"
hero_image_alt: "Open door in a long empty hallway — visual metaphor for the avoidant pattern of seeking exits from intimate spaces"
---
...
- A bad person. Bad people don't lose sleep over this. You do.
- Incapable of love. You feel love. You feel it accurately. You also feel something else underneath it that you have not named.
- Commitment-phobic in the sitcom sense. You can commit. You commit professionally, financially, intellectually, and to the *idea* of relationships. The breakdown is not at commitment. The breakdown is at sustained closeness.
- Doomed. Avoidant patterns are some of the most changeable patterns in attachment work, when the work is done right. You are not stuck. You are habituated.

**You are:**

- Someone whose nervous system, very early, learned that closeness was unsafe — and learned it well enough that it now overrides your conscious wants.
- Someone who has built a life that lets them perform closeness without having to feel it. (Career success often makes this easier, not harder. We'll get to that.)
- Someone who is finally, possibly for the first time, sitting with the cost of how good the avoidance has been at protecting you.
...
- **The slow fade.** You become so absent that they leave. You can tell yourself they ended it.
- **The unbearable behavior.** You become someone they can't stay with. You can tell yourself you were honest, or going through something.
- **The affair.** Someone new appears. The pursuit phase becomes available again. The relationship that was suffocating you becomes something you are fleeing rather than failing.
- **The deal-breaker confession.** You bring up something — values, future plans, sex, money — that you know will end it. You can tell yourself you were just being clear.
- **The disappearance.** You leave. Sometimes literally, sometimes emotionally. You do not explain.
...
- **Closeness was punished or shamed.** You needed something — comfort, attention, contact — and you got back coldness, mockery, or anger. You learned that needs were embarrassing. You learned that needing was the problem, not the unmet need.
- **Closeness was inconsistent.** Sometimes your caregiver was warm and present. Sometimes they were distant or harsh. You couldn't predict which. You learned that closeness was not safe to count on, and that the safer move was not to count on it.
- **Closeness was conditional.** Love was available *if* you performed — academically, behaviorally, emotionally. You learned that you were loved for what you produced, not for what you were. You learned to lead with achievement, because achievement was what worked.
- **Closeness was overwhelming.** A caregiver was emotionally enmeshed with you, used you for their own needs, or made their love feel like a demand. You learned that closeness was not freely given but extracted. You learned to move away from the extraction.
- **Closeness disappeared.** A parent died, left, was sick, was emotionally absent, or was physically present but psychologically gone. You learned that closeness ends. You learned not to invest too heavily in something you would lose.
...
- I feel trapped (which usually means: I feel responsible for someone else's emotional state)
- I feel suffocated (which usually means: I am being asked for something I don't know how to give)
- I feel angry that they want this from me (which usually means: I learned that being needed was dangerous)
- I feel ashamed (which usually means: they have seen something in me I haven't accepted)
- I feel terrified that they'll leave anyway, so I want to leave first
...
We've written more on this — particularly on the affair as an exit strategy — in [Why Did I Cheat? Understanding the Affair as an Exit](/writing/why-did-i-cheat-understanding-the-affair-as-an-exit).
...
[Schedule a confidential consultation](/writing) when you're ready.

### Continue reading
- **[Avoidant Attachment in Marriage: When Closeness Feels Like Danger](/writing/avoidant-attachment-in-marriage-when-closeness-feels-like-danger)** — A deeper look at what avoidant attachment does specifically inside a long-term partnership.
- **[Why Did I Cheat? Understanding the Affair as an Exit Strategy](/writing/why-did-i-cheat-understanding-the-affair-as-an-exit)** — For the unfaithful partner trying to understand what just happened to their life.
- **[The Fight You Keep Having (And What It's Really About)](/writing/the-fight-you-keep-having-and-what-its-really-about)** — Avoidant-pursuer dynamics, and why the same fight keeps happening forever.

---

*Written by Jennifer at West Oak Therapy & Consultation. Specializing in attachment work for high-performing professionals navigating intimacy patterns and relationship repair. Confidential telehealth available.*
...
That contradiction is the avoidant pattern. The conscious mind wants the relationship; an older, faster part of the nervous system perceives closeness as threatening based on early experience. The two parts are operating on different timelines and different information.

**Is it possible to repair a marriage after I've already caused major damage (infidelity, withdrawal, etc.)?**
Often, yes — but the work is harder than typical couples therapy and requires the avoidant partner to do significant individual work, not just relational work. Repair is built over months, not weeks, and depends on the avoidant partner's willingness to stay in discomfort that the pattern would normally have them avoid.

**How does therapy with West Oak differ from typical couples counseling for this issue?**
We work with the underlying attachment patterns directly, not just the behaviors. For avoidant clients, this often means a combination of individual and couples work, attachment-informed approaches, and a therapist who will not let the pattern run the therapy itself.

...
export default function MirrorExperience() {
  ...
  const [path, setPath] = useState<"relationship" | "substances" | "disconnected" | "unknown" | null>(null);
  ...
  const handleChoice = (selectedPath: "relationship" | "substances" | "disconnected" | "unknown") => {
    setPath(selectedPath);
    setStage("mirror");
  };

  return (
    <div className="min-h-screen bg-black text-white font-dm selection:bg-brand-teal selection:text-white overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        {stage === "question" && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0, y: -50 }}
            className="h-screen flex flex-col items-center justify-center p-6 max-w-4xl mx-auto text-center"
          >
        ...
        {stage === "mirror" && path && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="h-screen flex flex-col items-center justify-center p-6 text-center max-w-3xl mx-auto"
        ...
        {stage === "insight" && path && (
          <motion.div 
            ...
            exit={{ opacity: 0 }}
            className="h-screen flex flex-col items-center justify-center p-6 text-center max-w-3xl mx-auto bg-gradient-to-b from-black to-brand-coffee/20"
        ...
        {stage === "guide" && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-brand-vermilion text-brand-coffee"
          ...
          >
            ...
            >
              <p>I'm Jennifer Weinmann—licensed therapist and someone who has spent 14 years working with high-performing people who look like they have it all together.</p>
              <p className="font-bold text-brand-teal">No judgment. No shortcuts. No pretending.</p>
              <p>Just someone who sees what's actually happening and knows the way through.</p>
            </motion.div>
             <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        {stage === "door" && (
          <motion.div 
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="h-screen flex flex-col items-center justify-center p-6 text-center bg-white text-brand-coffee"
          >
